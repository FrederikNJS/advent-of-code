...
RSpec.describe '2019/22/Part2' do
    it 'deal into new stack' do
        index = 2
        max = 9
        new_index = Day201922Part2::deal_into_new_deck(max, index)
    ...
    it 'cut n' do
        index = 2
        max = 9
        new_index = Day201922Part2::cut(max, index, 3)
    ...
    it 'cut n negative' do
        index = 2
        max = 9
        new_index = Day201922Part2::cut(max, index, -4)
    ...
    it 'deal with increment' do
        index = 2
        max = 9
        new_index = Day201922Part2::deal_with_increment(max, index, 3)
        expect(new_index).to eq 4
        #[0, 7, 4, 1, 8, 5, 2, 9, 6, 3]
    end

    xit 'works with example 1' do
        deck = (0..9).to_a
        instructions = [
        ...
        res = Day201922Part2::shuffle(deck, instructions)
        expect(res).to eq [0, 3, 6, 9, 2, 5, 8, 1, 4, 7]
    end

    xit 'works with example 2' do
        deck = (0..9).to_a
        instructions = [
            "cut 6",
            "deal with increment 7",
